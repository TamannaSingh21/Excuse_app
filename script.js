...
clg.addEventListener("click", function () {
  ...
  function onerror() {
    clgdiv.textContent = "Click the below button for next Excuse!!!";
  }
...
//********************************office Excuse*****************************//
  ...
  function onerror() {
    officediv.textContent = "Click the below button for next Excuse!!!";
  }
...
function onerror() {
  childdiv.textContent = "Click the below button for next Excuse!!!";
}
...
function onerror() {
  partydiv.textContent = "Click the below button for next Excuse!!!";
}
